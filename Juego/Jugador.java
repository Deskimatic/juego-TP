...
public class Jugador {
    ...
    public Jugador(String nombre, int fila, int columna) {
        ...
        imagenArriba = new ImageIcon(
                getClass().getResource("/Juego/recursos/pacmanUp.png")
        ).getImage();

        imagenAbajo = new ImageIcon(
                getClass().getResource("/Juego/recursos/pacmanDown.png")
        ).getImage();

        imagenIzquierda = new ImageIcon(
                getClass().getResource("/Juego/recursos/pacmanLeft.png")
        ).getImage();

        imagenDerecha = new ImageIcon(
                getClass().getResource("/Juego/recursos/pacmanRight.png")
        ).getImage();
    ...
    public void recibirDaño(int cantidad) {
        ...
        System.out.println(
                "Pac-Man perdió una vida. Vidas restantes: " + salud
        );
    }
    ...
    public void mostrarEstado() {
        ...
        System.out.println("Poder activo: " + poderActivo);
    }
